...
**当前阶段**：原理图 v0.6、PCB 布局与网络分配已完成，J2 与 GY-87 引脚顺序已对齐。**载板尚未布线**——固件与久坐算法仍在 [03-ESP32-OLED-Button-Demo](../../03-ESP32-OLED-Button-Demo) / [04-MCU-GY87-Debug](../../04-MCU-GY87-Debug) 中联调；软件侧接口稳定后再完成走线、DRC 与打样。

| 版本 | 日期 | 变更 |
|------|------|------|
| 原理图 v0.6 | 2026-06 | 仅 J1 MCU + J2 GY-87 + J3 电源 + J4 OLED；移除载板按键/滑动开关 |
| PCB v0.4 | 2026-06 | 布局 + 网络分配；J2 可直插 GY-87；**走线待软件联调完成后进行** |
